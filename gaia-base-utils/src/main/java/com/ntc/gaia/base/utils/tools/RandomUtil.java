...
public class RandomUtil {
     ...
     * @param pref   前缀字符
     */
    public static String generteNID(String pref, int length) {

        if (pref != null && pref.trim().length() > 0) {
            return pref + generateNumString(length);
        }
        return generateNumString(length);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("10wei=:" + generteNID("MIN", 10));
