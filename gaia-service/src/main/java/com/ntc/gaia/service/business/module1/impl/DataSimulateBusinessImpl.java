...
@Service("DataSimulateBusiness")
public class DataSimulateBusinessImpl implements DataSimulateBusiness{
    @Autowired
    private DataSimulateDao dataSimulateDao;

    public List dataSimulateLogic(String userId) throws BusinessException{
