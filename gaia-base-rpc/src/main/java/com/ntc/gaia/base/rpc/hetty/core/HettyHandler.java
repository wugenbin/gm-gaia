...
import com.ntc.gaia.base.rpc.hetty.object.RequestWrapper;
...
public class HettyHandler extends SimpleChannelUpstreamHandler {
	...
	private void handleService(final String serviceName, final HttpRequest request, final HttpResponse response,
			final ByteArrayOutputStream os, final MessageEvent e) throws Exception {
	 ...
	 */
	public void service(String serviceName, HttpRequest req, HttpResponse res, ByteArrayOutputStream os) {
